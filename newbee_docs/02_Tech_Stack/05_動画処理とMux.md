...
| 用語 | 意味 | TASUKIでの利用 |
|------|------|-------------|
| **Encoding (エンコード)** | データを圧縮・変換すること | Muxが自動で行う |
| **HLS** | HTTP Live Streaming | 動画を分割して配信する技術 |
| **Streaming (ストリーミング)** | ダウンロードしながら再生すること | 待ち時間がない |
| **CDN** | Content Delivery Network | 世界中に動画をキャッシュして高速配信する仕組み |
| **Webhook** | イベント通知 | 「動画処理終わったよ！」とサーバーに知らせる |
| **Playback ID** | 再生用ID | 動画を再生するために必要なID |
