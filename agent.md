...
- **要件定義**：`docs/BATON_requirements_v8.5.yaml`
- **実装手引書**：`docs/BATON_implementation_guide_v1.0.yaml`
- **現行プラン**：`plan.md`
...
5. すべての回答・コミュニケーションは日本語で行い、例外的に必要な場合のみ補足的に英語を添える。
...
5. **報告**：変更概要、ファイル参照、検証結果を必ず日本語でまとめる（必要に応じて英語を補足として付与してよい）。
